...
| ID         | Objective                                                        | Preconditions                                   | Expected result                                                                                                             | ✔   |
| ---------- | ---------------------------------------------------------------- | ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- | --- |
| **TC-051** | A valid image upload sets the product image                      | Admin session, valid png/jpeg/webp under 500 KB | Upload succeeds; the new image is reflected on the next `GET`                                                               | ✅  |
